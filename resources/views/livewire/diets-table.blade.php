  ...
  <div class="max-h-full w-full max-w-xl overflow-y-auto sm:rounded-2xl bg-white">
    <div class="w-full">
      <div class="m-8 my-20 max-w-[400px] mx-auto">
        <div class="mb-8">
          <h1 class="mb-4 text-3xl font-extrabold">Nombre de la dieta: {{$myDiet->title}}</h1>
          <h1 class="mb-4 text-3xl font-extrabold">Descripción de la dieta: {{$myDiet->description}}</h1>
          <h1 class="mb-4 text-3xl font-extrabold">Fecha de la dieta: {{$myDiet->fecha}}</h1>
